...
SECRET_KEY = 'django-insecure-4syeoy@h_0x-h^qbj*05of_%ojq5js4wb7jonbkebnq=6)o@lb'
...
WSGI_APPLICATION = 'StackcloneBackend.wsgi.application'
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        # Puedes agregar más personalizaciones de serializers aquí
    },
}
